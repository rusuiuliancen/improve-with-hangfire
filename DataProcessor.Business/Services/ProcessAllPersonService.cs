...
{
    public class ProcessAllPersonService : IProcessAllPersonService
    {
        private readonly AppDbContext _dbContext;

        public ProcessAllPersonService(AppDbContext dbContext)
        {
        ...
        public void RecalculateAge(Guid personId)
        {
            ...
            if (person != null)
            {
                ...
                //if (person.Age < 35)
                //{
                //    throw new InvalidOperationException("Age is less than 35.");
                //}
